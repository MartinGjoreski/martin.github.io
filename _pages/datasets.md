...
* Labeled datasets for cognitive-load monitoring with a wearable device: [link](https://martingjoreski.github.io/files/CogDatasets.rar)
...
* Labeled datasets for stress monitoring with a wearable device
  * The datasets can be used only for research purposes
